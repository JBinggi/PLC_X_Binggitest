<?php
/**
 * Binggitest.php - Binggitest Entity
 *
 * Entity Model for Binggitest
 *
 * @category Model
 * @package Binggitest
...
class Binggitest extends CoreEntityModel {
    public $label;

    /**
     * Binggitest constructor.
     *
    ...
    public function exchangeArray(array $aData) {
        $this->id = !empty($aData['Binggitest_ID']) ? $aData['Binggitest_ID'] : 0;
