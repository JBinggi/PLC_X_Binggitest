<?php
/**
 * ApiController.php - Binggitest Api Controller
 *
 * Main Controller for Binggitest Api
 *
 * @category Controller
 * @package Application
...
class ApiController extends CoreController {
    ...
    public function indexAction() {
        ...
        $aReturn = ['state'=>'success','message'=>'Welcome to onePlace Binggitest API'];
    ...
    /**
     * List all Entities of Binggitests
     *
     * @return bool - no View File
     * @since 1.0.0
     */
    public function listAction() {
        ...
        # Get All Binggitest Entities from Database
    ...
    /**
     * Get a single Entity of Binggitest
     *
     * @return bool - no View File
     * @since 1.0.0
     */
    public function getAction() {
        ...
        try {
            ...
            $aReturn = ['state'=>'error','message'=>'Binggitest not found','oItem'=>[]];
            echo json_encode($aReturn);
            return false;
        }

        # Print Entity
        $aReturn = ['state'=>'success','message'=>'Binggitest found','oItem'=>$oItem];
        echo json_encode($aReturn);
