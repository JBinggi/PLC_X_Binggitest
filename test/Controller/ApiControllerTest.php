...
use OnePlace\Binggitest\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/binggitest/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/binggitest/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('binggitest-api');
    }
}
