<?php
/**
 * BinggitestControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Binggitest Module
 *
 * @category Test
 * @package Binggitest
...
namespace OnePlaceTest\Binggitest\Controller;

use OnePlace\Binggitest\Controller\BinggitestController;
...
class BinggitestControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/binggitest', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('binggitest');
        $this->assertControllerName(BinggitestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BinggitestController');
        $this->assertMatchedRouteName('binggitest');
    }
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/binggitest/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('binggitest');
        $this->assertControllerName(BinggitestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BinggitestController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/binggitest/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('binggitest');
        $this->assertControllerName(BinggitestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BinggitestController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/binggitest/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('binggitest');
        $this->assertControllerName(BinggitestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('BinggitestController');
